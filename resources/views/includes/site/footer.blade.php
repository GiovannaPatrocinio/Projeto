...
<footer class="footer set-bg" data-setbg="{{ asset('assets/images/site/footer-bg.jpg') }}">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="footer__contact__option">
                        <div class="option__item"><i class="fa fa-phone"></i> (14)99884-5789</div>
                        <div class="option__item email"><i class="fa fa-envelope-o"></i> projetolpwebii@gmail.com</div>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="footer__about">
                    ...
                    <p>99884-5789 | Jardim Teste, São Paulo - SP</p>
        ...
        <div class="footer__copyright__text">
            <p>{{ config('app.name') }} &copy; {{ date('Y') }} Todos os direitos reservados</a></a></p>
        </div>
        <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
    </div>
</footer>
